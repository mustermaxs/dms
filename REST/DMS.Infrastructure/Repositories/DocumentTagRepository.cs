...
//
// public class DocumentTagRepository(DmsDbContext dbContext, IValidator<DocumentTag> validator, IMapper mapper)
//     : BaseRepository<DocumentTag, DocumentTags>(dbContext, validator, mapper),
//         IDocumentTagRepository
// {
//     public async Task<DocumentTag> CreateOrGetIfExists(DocumentTag documentTag)
//     {
//         // TODO also execute TagModel validator here
